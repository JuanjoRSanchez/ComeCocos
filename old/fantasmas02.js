...
window.addEventListener("load", function (event) {
    console.log(document.getElementById("5:2"));
    ...
    switch (fantasmaRosa.direccion) {
        case 'derecha':
            ...
            if (evaluarMovimientoFantasma(caminoEvaluarRosa)) {
                ...
                let classmovimiento = document.getElementById(caminoEvaluarRosa).getAttribute('class');
                if (classmovimiento === 'caja') {
                    document.getElementById(pos).setAttribute('class', 'caja');
                }
                else if (classmovimiento === 'fantasmaRojo01'
                    || classmovimiento === 'fantasmaAzul01' || classmovimiento === 'fantasmaNaranja01') {
                    break;
                } else if (classmovimiento === 'comecocos'
                    || classmovimiento === 'comecocosCerrado' ) {
                    break;
                }
                else {
                ...
                document.getElementById(caminoEvaluarRosa).classList.add('fantasmaRosa01');
    ...
    switch (fantasmaRojo.direccion) {
        case 'derecha':
            ...
            if (evaluarMovimientoFantasma(caminoEvaluarRojo)) {
                ...
                let classmovimiento = document.getElementById(caminoEvaluarRojo).getAttribute('class');
                if (document.getElementById(caminoEvaluarRojo).getAttribute('class') === 'caja') {
                    document.getElementById(pos).setAttribute('class', 'caja');
                } else if (classmovimiento === 'fantasmaRosa01'
                    || classmovimiento === 'fantasmaAzul01' || classmovimiento === 'fantasmaNaranja01') {
                    break;
                }else if (classmovimiento === 'comecocos'
                || classmovimiento === 'comecocosCerrado' ) {
                ...
                document.getElementById(caminoEvaluarRojo).classList.add('fantasmaRojo01');
                ...
                if (randomDireccionesTotal(caminoEvaluarRojo) == false) {
                    ...
                    fantasmaRojo.direccion = randomDireccionesTotal(caminoEvaluarRojo);
                }
            }
            break;
        case 'izquierda':
...
function movimientoFantasmaNaranjaTotal() {
    let fa = document.getElementById('fantasmaNaranja01');
    if(fa){
        document.getElementById(fantasmaAzul.posicion).setAttribute('class ', 'fantasmaNaranja01') ;
    }
    ...
    switch (fantasmaNaranja.direccion) {
        case 'derecha':
            ...
            if (evaluarMovimientoFantasma(caminoEvaluarNaranja)) {
                ...
                let classmovimiento = document.getElementById(caminoEvaluarNaranja).getAttribute('class');
                if (document.getElementById(caminoEvaluarNaranja).getAttribute('class') === 'caja') {
                    ...
                    || classmovimiento === 'fantasmaAzul01') {
                    break;
                } else if (classmovimiento === 'comecocos'
                || classmovimiento === 'comecocosCerrado' ) {
                break;
                ...
                document.getElementById(caminoEvaluarNaranja).classList.add('fantasmaNaranja01');
                if (randomDireccionesTotal(caminoEvaluarNaranja) == false) {
                    ...
                    fantasmaNaranja.direccion = randomDireccionesTotal(caminoEvaluarNaranja);
                }
            }
            break;
        case 'izquierda':
...
function movimientoFantasmaAzulTotal() {
    let fa = document.getElementById('fantasmaAzul01');
    if(fa){
        document.getElementById(fantasmaAzul.posicion).setAttribute('class ', 'fantasmaAzul01') ;
    }
    ...
    switch (fantasmaAzul.direccion) {
        case 'derecha':
            ...
            if (evaluarMovimientoFantasma(caminoEvaluarAzul)) {
                ...
                let classmovimiento = document.getElementById(caminoEvaluarAzul).getAttribute('class');

                if (document.getElementById(caminoEvaluarAzul).getAttribute('class') === 'caja') {
                    document.getElementById(pos).setAttribute('class', 'caja');
                } else if (classmovimiento === 'fantasmaRosa01' || classmovimiento === 'fantasmaRojo01'
                    || classmovimiento === 'fantasmaNaranja01') {
                    break;
                }else if (classmovimiento === 'comecocos'
                || classmovimiento === 'comecocosCerrado' ) {
                break;
                ...
                document.getElementById(caminoEvaluarAzul).classList.add('fantasmaAzul01');
...
/*
function movimiento(nuevaPosicion, pos, color) {
    if (evaluarMovimientoFantasma(nuevaPosicion)) {
        fantasmaRosa.posicion = nuevaPosicion;
        if (document.getElementById(nuevaPosicion).getAttribute('class') === 'caja') {
            document.getElementById(pos).setAttribute('class', 'caja');
        } else {
            document.getElementById(pos).setAttribute('class', 'cajaNegra');
        }
        switch (color) {
            case 'rosa':
                document.getElementById(nuevaPosicion).setAttribute('class', 'fantasmaRosa01');
                break;
            case 'rojo':
                document.getElementById(nuevaPosicion).setAttribute('class', 'fantasmaRojo01');
                break;
            case 'azul':
                document.getElementById(nuevaPosicion).setAttribute('class', 'fantasmaAzul01');
                break;
            case 'naranja':
                document.getElementById(nuevaPosicion).setAttribute('class', 'fantasmaNaranja01');
                break;
        }
        if (randomDireccionesTotal(nuevaPosicion) == false) {
            return false;
        } else {
...
function movimientoFantasmaRosaTotal() {
    ...
    switch (fantasmaRosa.direccion) {
        case 'derecha':
            DX = DX + 1;
            caminoEvaluarRosa = DY + ':' + DX;
            if (!movimiento(caminoEvaluarRosa, pos, color)){
                break;
            }
            break;
        case 'izquierda':
            DX = DX - 1;
            caminoEvaluarRosa = DY + ':' + (DX);
            movimiento(caminoEvaluarRosa, pos, color);
            break;
        case 'arriba':
            DY = DY - 1;
            caminoEvaluarRosa = DY + ':' + (DX);
...
function movimientoFantasmaRojoTotal() {
    ...
    switch (fantasmaRojo.direccion) {
        case 'derecha':
            DX = DX + 1;
            caminoEvaluarRojo = DY + ':' + DX;
            if (!movimiento(caminoEvaluarRojo, pos, color)){
                break;
            }
            break;
        case 'izquierda':
